...
- **Умное автоопределение языка** - система автоматически определяет язык программирования
...
## 🤖 Умная система определения языка

Платформа автоматически определяет язык программирования на основе:

### **Анализ синтаксиса:**
- **Ключевые слова** - function, class, import, etc.
- **Специфичные паттерны** - <?php, <template>, @if, etc.
- **Структура кода** - отступы, скобки, операторы

### **Поддерживаемые языки:**
- **Основные:** PHP, JavaScript, TypeScript, Python, Java, C#, C++, Go, Rust, HTML, CSS, SQL
- **Смешанные:** PHP+HTML, Vue.js, Laravel Blade, JSX/TSX, HTML+CSS, HTML+JS, PHP+Blade
- **Дополнительные:** Ruby, Swift, Kotlin, Scala, Dart, Elixir, Haskell, Clojure, Bash, PowerShell, YAML, JSON, XML, Markdown

### **Особенности:**
- **Уверенность определения** - показывает процент точности
- **Альтернативные варианты** - предлагает другие возможные языки
- **Автоматическое определение** - работает при вводе кода
- **Ручное переопределение** - пользователь может изменить выбор
